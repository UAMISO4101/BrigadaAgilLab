...
var ExperimentoAsociarProtocoloComponent = (function () {
    ...
    ExperimentoAsociarProtocoloComponent.prototype.getProtocolos = function () {
        var _this = this;
        this._protocoloService.listarProtocolos().subscribe(function (protocolos) {
            return _this.protocolos = protocolos;
        });
    };
    ExperimentoAsociarProtocoloComponent.prototype.getExperimento = function () {
        ...
        this._experimentoService.getExperimentos().subscribe(function (experimento) {
            return _this.experimento = experimento.filter(function (p) {
                return p.id == _this.idExperimento;
            }).pop();
        }, function (error) {
            return console.log(error);
        }, function () {
            return _this.asociarProtocolo(_this.experimento, _this.protocolo);
        });
    };
    ExperimentoAsociarProtocoloComponent.prototype.asociarProtocolo = function (experimento, protocolo) {
        ...
        this._experimentoService.asociarProtocolo(experimento, protocolo).subscribe(function (res) {
