# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-05-20 06:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='experimentoasistente',
            name='asistente',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='laboratorio.Usuario'),
        ),
        migrations.AddField(
            model_name='experimentoasistente',
            name='experimento',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='laboratorio.Experimento'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='avanceprotocoloexperimentoproyecto',
            name='proyecto',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='laboratorio.Proyecto'),
        ),
        migrations.AlterUniqueTogether(
            name='proyectoexperimento',
            unique_together=set([('proyecto', 'experimento')]),
        ),
        migrations.AlterUniqueTogether(
            name='experimentoprotocolo',
            unique_together=set([('experimento', 'protocolo')]),
        ),
        migrations.AlterUniqueTogether(
            name='experimentoasistente',
            unique_together=set([('experimento', 'asistente')]),
        ),
    ]
